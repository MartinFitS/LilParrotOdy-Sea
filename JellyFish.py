...
class JellyFish(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.sprites.append(pygame.image.load("./ninos/morro1.png").convert())
        self.sprites.append(pygame.image.load("./ninos/morro2.png").convert())
        self.sprites.append(pygame.image.load("./ninos/morro3.png").convert())
        self.sprites.append(pygame.image.load("./ninos/morro4.png").convert())
